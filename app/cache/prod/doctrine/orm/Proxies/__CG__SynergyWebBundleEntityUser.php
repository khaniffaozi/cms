 ...
 */
class User extends \Synergy\WebBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Synergy\\WebBundle\\Entity\\User' . "\0" . 'id', '' . "\0" . 'Synergy\\WebBundle\\Entity\\User' . "\0" . 'email', '' . "\0" . 'Synergy\\WebBundle\\Entity\\User' . "\0" . 'username', '' . "\0" . 'Synergy\\WebBundle\\Entity\\User' . "\0" . 'password', '' . "\0" . 'Synergy\\WebBundle\\Entity\\User' . "\0" . 'userType', '' . "\0" . 'Synergy\\WebBundle\\Entity\\User' . "\0" . 'country', '' . "\0" . 'Synergy\\WebBundle\\Entity\\User' . "\0" . 'isActive');
        }
