 ...
 */
class Country extends \Synergy\WebBundle\Entity\Country implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Synergy\\WebBundle\\Entity\\Country' . "\0" . 'id', '' . "\0" . 'Synergy\\WebBundle\\Entity\\Country' . "\0" . 'countryName');
        }
